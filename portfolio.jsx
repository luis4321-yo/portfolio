  ...
  const projects = [
    {
      ...
      title: "Project One",
      tag: "Web Application",
      desc: "A brief description of what this project does and the problem it solves. Replace this text with your own project details.",
    ...
    <div className="relative min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden">
      ...
      <div className="relative" style={{ zIndex: 2 }}>
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-center justify-center max-w-7xl mx-auto">
            ...
            <div className="flex-1">
              ...
              <p
                ...
                style={{ fontFamily: "'JetBrains Mono', monospace" }}
              >
                A short sentence about who you are and what you care about. Edit this text
                to introduce yourself — what you design, build, or break for fun.
              </p>
            </div>
          </div>
        </header>
        ...
        <section id="work" className="px-8 md:px-16 pb-32">
          <div className="flex items-baseline justify-between mb-16 border-b border-slate-800 pb-6">
            ...
            <span
              ...
              style={{ fontFamily: "'JetBrains Mono', monospace" }}
            >
              [ {String(currentProject + 1).padStart(2, '0')} / 03 ]
            </span>
          </div>
              ...
              <div className="relative border border-slate-800 backdrop-blur-sm transition-all duration-500 bg-slate-900/50">
                ...
                <div className="grid grid-cols-1 gap-8 p-12">
                  ...
                  <div className="relative">
                    <div className="aspect-video bg-slate-800 rounded-lg overflow-hidden max-w-3xl mx-auto w-full">
                      <img
        ...
        >
          ...
          <div className="flex gap-6 text-xs tracking-[0.3em] text-slate-400">
